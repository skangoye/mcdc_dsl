...
public class MCDC_Of_Decision2 {
    ...
    try {
      ...
      final Procedure1<List<Couple<Couple<String, Integer>, Couple<String, Integer>>>> _function = new Procedure1<List<Couple<Couple<String, Integer>, Couple<String, Integer>>>>() {
        public void apply(final List<Couple<Couple<String, Integer>, Couple<String, Integer>>> list) {
          ...
          String _plus_9 = (MCDC_Of_Decision2.FalseChar + _first_2);
          finalMCDCValues.add(_plus_9);
          String _first_3 = couple2.getFirst();
          String _plus_10 = (MCDC_Of_Decision2.TrueChar + _first_3);
      ...
      String _plus_3 = ("Final Values: " + _string);
  ...
  private void mcdcDepthFirstSearch(final EXPRESSION exp, final List<List<Triplet<String, String, String>>> resultList) {
    try {
      if ((exp instanceof AND)) {
        ...
        Triplet<String, String, String> _triplet_3 = new Triplet<String, String, String>("T", "11", "0");
        rightList.add(_triplet_3);
        Triplet<String, String, String> _triplet_4 = new Triplet<String, String, String>("F", "21", "0");
        rightList.add(_triplet_4);
        Triplet<String, String, String> _triplet_5 = new Triplet<String, String, String>("T", "22", "0");
        ...
        if ((exp instanceof OR)) {
          ...
          Triplet<String, String, String> _triplet_6 = new Triplet<String, String, String>("T", "11", "1");
          leftList_1.add(_triplet_6);
          Triplet<String, String, String> _triplet_7 = new Triplet<String, String, String>("F", "12", "1");
          leftList_1.add(_triplet_7);
          Triplet<String, String, String> _triplet_8 = new Triplet<String, String, String>("F", "21", "1");
          leftList_1.add(_triplet_8);
          Triplet<String, String, String> _triplet_9 = new Triplet<String, String, String>("F", "11", "0");
          rightList_1.add(_triplet_9);
          Triplet<String, String, String> _triplet_10 = new Triplet<String, String, String>("T", "12", "0");
          rightList_1.add(_triplet_10);
          Triplet<String, String, String> _triplet_11 = new Triplet<String, String, String>("F", "21", "0");
          rightList_1.add(_triplet_11);
          ...
          if ((exp instanceof NOT)) {
            ...
            if (_or) {
              ...
              Triplet<String, String, String> _triplet_12 = new Triplet<String, String, String>("T", "1", "");
              list.add(_triplet_12);
              Triplet<String, String, String> _triplet_13 = new Triplet<String, String, String>("F", "2", "");
              list.add(_triplet_13);
              resultList.add(list);
            } else {
